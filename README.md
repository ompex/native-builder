...
only manual dispatches, checks out the requested commit with a masked
least-privilege credential in an ephemeral runner, and does not upload source or
build artifacts in the initial proof.
